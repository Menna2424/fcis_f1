...
class ContentListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(title,style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),)),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text( lectureName , style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: ColorsManager.backGroundColor),)),
                  ),
                ),
              ),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Center(child: Text(name,style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold),)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              SelectableText(url, style: TextStyle(fontSize: 16,color: Colors.grey)), // Allow URL selection
              SizedBox(height: 30),
              ElevatedButton.icon(
                onPressed: () {
